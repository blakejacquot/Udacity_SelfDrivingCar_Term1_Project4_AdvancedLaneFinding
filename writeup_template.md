...
* Compute the camera calibration matrix and distortion coefficients given a set of chessboard images. (Not Done)
* Apply a distortion correction to raw images. (Not Done)
